...
function FloatingOrb({ style }: { style?: React.CSSProperties }) {
  return (
    <div className="absolute rounded-full pointer-events-none blur-3xl" style={style} />
  );
}
  ...
  return (
    <div className="min-h-screen overflow-x-hidden" style={{ background: "var(--bg-primary)" }}>
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center px-5 pt-24 pb-16 text-center overflow-hidden">
        {/* Fire orbs — intentional asymmetry */}
        <FloatingOrb style={{ width: 600, height: 600, top: 0, left: "50%", transform: "translateX(-50%)", background: "radial-gradient(circle at 50% 30%, rgba(255,45,85,0.13) 0%, transparent 65%)", animation: "float-y 7s ease-in-out infinite" }} />
        <FloatingOrb style={{ width: 350, height: 350, top: "25%", right: "-12%", background: "radial-gradient(circle, rgba(251,146,60,0.1) 0%, transparent 70%)", animation: "float-y 9s ease-in-out infinite 2s" }} />
        <FloatingOrb style={{ width: 250, height: 250, bottom: "18%", left: "-5%", background: "radial-gradient(circle, rgba(220,38,38,0.09) 0%, transparent 70%)", animation: "float-y 6s ease-in-out infinite 1s" }} />
        ...
        >
          ...
          {/* ── EDITORIAL HEADLINE — one word per line, massive ── */}
          <motion.div
          ...
          >
            <h1
              ...
              style={{ fontSize: "clamp(4.5rem, 16vw, 10rem)", letterSpacing: "-0.05em" }}
            >
              BIKIN<br />
              MUSIK<br />
          ...
          <motion.p
            ...
            className="text-[var(--text-muted)] mt-7 mb-8 leading-relaxed max-w-sm mx-auto"
          ...
          >
            {["✓ 100 kredit gratis", "✓ Tanpa kartu kredit", "✓ Langsung jadi"].map(t => (
              <span key={t} className="text-xs text-[var(--text-faint)] px-3 py-1.5 rounded-full border border-[var(--border-subtle)] bg-[var(--bg-elevated)]">
                {t}
              </span>
            ))}
          </motion.div>
        ...
        <motion.div
          ...
          animate={{ opacity: 1 }}
          transition={{ delay: 1 }}
          className="relative z-10 flex items-end justify-center gap-px mt-16"
          style={{ height: 40 }}
        >
      ...
      <div className="section-rule mx-5" />
      ...
      <section className="px-5 py-20 max-w-xl mx-auto">
        <motion.div {...fadeUp(0)} className="mb-10">
          ...
          <h2
            className="heading-display text-[var(--text-primary)]"
        ...
        <div className="divide-y divide-[var(--border-subtle)]">
          {[
            ...
            >
              {/* Big faint editorial number */}
              <div
                className="num-editorial flex-shrink-0 leading-none"
                style={{ fontSize: "clamp(3.5rem, 10vw, 5.5rem)", minWidth: "4.5rem" }}
              >
                {n}
              </div>
              <div className="pt-1">
      ...
      {/* ── 3 Modes — FEATURED HERO CARD + 2 SECONDARY ────────── */}
      <section ref={featuresRef} className="px-5 py-20">
        <motion.div {...fadeUp(0)} className="mb-12 max-w-lg mx-auto">
          ...
          <p className="text-[var(--text-muted)] text-sm mt-3">
            Dari lagu doang sampai musik video penuh
          </p>
        </motion.div>
        ...
        <div className="max-w-lg mx-auto space-y-4">
          ...
          <motion.div
            {...fadeUp(0.05)}
            className="card-glass-red overflow-hidden"
            style={{ padding: 0 }}
          >
            {/* Mini waveform header decoration */}
            <div className="flex items-end gap-px h-12 px-6 pt-4">
            ...
            <div className="px-6 pb-6 pt-4 flex gap-4 items-start">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="label-caps px-2 py-0.5 rounded-full text-white bg-gradient-red shadow-glow text-[9px]">
                    LIVE
                  </span>
                </div>
          ...
          {/* ── SECONDARY: Novel + Video (Coming Soon) ── */}
          {[
            ...
            <motion.div
              key={feat.title}
              {...fadeUp(0.12 + i * 0.1)}
              className={`${feat.card} p-5 flex gap-4 items-center`}
            >
              <div className="w-11 h-11 rounded-xl flex-shrink-0 flex items-center justify-center text-xl"
                style={{ background: `${feat.dotColor}14` }}>
                {feat.icon}
              </div>
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-0.5">
                  <h3 className="font-semibold text-[var(--text-primary)] text-sm">{feat.title}</h3>
                  <span className="label-caps px-2 py-0.5 rounded-full bg-[var(--bg-elevated)] text-[var(--text-faint)] text-[8px]">
                    SEGERA HADIR
                  </span>
                </div>
                <p className="text-xs text-[var(--text-muted)] leading-relaxed truncate">{feat.desc}</p>
              </div>
            </motion.div>
          ))}
        </div>
      ...
      <section className="px-5 py-20 max-w-2xl mx-auto">
        <motion.div {...fadeUp(0)} className="mb-10">
          ...
          <p className="text-sm text-[var(--text-muted)] mt-3">Bukti nyata AI bisa bikin musik yang beneran bagus</p>
        </motion.div>
        ...
        >
          ...
          <div className="p-4 flex items-center justify-between border-t border-[var(--border-subtle)] bg-[var(--bg-elevated)]">
            <div>
      ...
      {/* ── Platform Distribution — "Hadir Di" ─────────────────── */}
      <section className="px-5 py-20 max-w-2xl mx-auto">
        <motion.div {...fadeUp(0)} className="text-center mb-12">
          ...
          <p className="text-[var(--text-muted)] text-sm mt-3">
            Musikmu akan bisa langsung kita publish ke semua platform
          </p>
        </motion.div>

        {/* Platform cards — creative asymmetric grid */}
        <div className="space-y-3">
          {/* Row 1 — YouTube (featured, full width) */}
          <motion.div
            {...fadeUp(0.05)}
            className="relative overflow-hidden rounded-2xl p-5 flex items-center gap-5 group"
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-[var(--text-muted)]">Upload langsung ke channel · Monetize dari hari pertama</p>
            </div>
            <span className="label-caps px-2.5 py-1 rounded-full text-[8px] flex-shrink-0" style={{ background: "rgba(255,0,0,0.1)", color: "#FF0000", border: "1px solid rgba(255,0,0,0.2)" }}>
              SEGERA
            </span>
            {/* Decorative waveform */}
            <div className="absolute right-16 top-0 bottom-0 flex items-center gap-px opacity-10 pointer-events-none">
          ...
          {/* Row 2 — 2 columns: TikTok + Spotify */}
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-[var(--text-muted)] leading-tight">Viral lewat For You Page</p>
              </div>
              <span className="label-caps text-[7px] px-2 py-0.5 rounded-full self-start" style={{ background: "rgba(255,255,255,0.06)", color: "rgba(255,255,255,0.4)" }}>
                SEGERA
              </span>
            </motion.div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-[var(--text-muted)] leading-tight">Streaming ke jutaan pendengar</p>
              </div>
              <span className="label-caps text-[7px] px-2 py-0.5 rounded-full self-start" style={{ background: "rgba(30,215,96,0.08)", color: "#1ED760", border: "1px solid rgba(30,215,96,0.2)" }}>
                SEGERA
              </span>
            </motion.div>
          </div>

          {/* Row 3 — Instagram + Noise Indonesia */}
          <div className="grid grid-cols-2 gap-3">
            <motion.div
              {...fadeUp(0.16)}
              className="relative overflow-hidden rounded-2xl p-4 flex flex-col gap-3"
            ...
            >
              <div className="w-11 h-11 rounded-xl flex items-center justify-center"
                style={{ background: "linear-gradient(135deg, rgba(225,48,108,0.15), rgba(193,53,132,0.1))" }}>
                {/* Instagram logo */}
              ...
              <div>
                ...
                <p className="text-xs text-[var(--text-muted)] leading-tight">Reels & Stories langsung</p>
              </div>
              <span className="label-caps text-[7px] px-2 py-0.5 rounded-full self-start" style={{ background: "rgba(225,48,108,0.08)", color: "#E1306C", border: "1px solid rgba(225,48,108,0.2)" }}>
                SEGERA
              </span>
            </motion.div>
            ...
            <motion.div
              {...fadeUp(0.19)}
              className="relative overflow-hidden rounded-2xl p-4 flex flex-col gap-3"
              style={{ background: "linear-gradient(135deg, rgba(255,45,85,0.07), rgba(251,146,60,0.04))", border: "1px solid rgba(255,45,85,0.18)" }}
            >
              {/* Noise Indonesia — custom logo treatment */}
              <div className="w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0"
                style={{ background: "linear-gradient(135deg, rgba(255,45,85,0.15), rgba(251,146,60,0.1))" }}>
                {/* Noise Indonesia "N" wordmark approximation */}
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
                  <rect width="24" height="24" rx="6" fill="url(#noise-grad)" opacity="0.15"/>
                  <defs>
                    <linearGradient id="noise-grad" x1="0" y1="0" x2="24" y2="24">
                      <stop stopColor="#ff2d55"/>
                      <stop offset="1" stopColor="#fb923c"/>
                    </linearGradient>
                  </defs>
                  <text x="12" y="17" textAnchor="middle" fill="url(#noise-grad)" fontSize="14" fontWeight="900" fontFamily="Arial, sans-serif">N</text>
                </svg>
              </div>
              <div>
                <p className="font-bold text-[var(--text-primary)] text-sm">Noise Indonesia</p>
                <p className="text-xs text-[var(--text-muted)] leading-tight">Platform musik lokal #1</p>
              </div>
              <span className="label-caps text-[7px] px-2 py-0.5 rounded-full self-start" style={{ background: "rgba(255,45,85,0.08)", color: "var(--accent-red)", border: "1px solid rgba(255,45,85,0.2)" }}>
                SEGERA
              </span>
            </motion.div>
          </div>
        ...
        <motion.p
          {...fadeUp(0.25)}
          className="text-center text-xs text-[var(--text-faint)] mt-6"
        >
      ...
      {/* ── Final CTA — BIG, BOLD, FULL-WIDTH ENERGY ───────────── */}
      <section className="px-5 py-24 text-center relative overflow-hidden">
        <FloatingOrb style={{ width: 550, height: 550, top: "50%", left: "50%", transform: "translate(-50%,-50%)", background: "radial-gradient(circle, rgba(255,45,85,0.11) 0%, transparent 65%)" }} />
        <motion.div {...fadeUp(0)} className="relative z-10 max-w-md mx-auto">
          <h2
            className="heading-display text-[var(--text-primary)] mb-6"
            style={{ fontSize: "clamp(2.8rem, 9vw, 6rem)", letterSpacing: "-0.05em", lineHeight: 0.92 }}
          >
            Siap Gas<br />
          ...
          <button onClick={onStart} className="btn-primary w-full rounded-2xl py-4 text-base">
      ...
      {/* ── Footer ─────────────────────────────────────────────── */}
      <footer className="border-t border-[var(--border-subtle)] px-5 py-10 text-center space-y-4">
        ...
        <div className="flex items-center justify-center gap-4 text-xs text-[var(--text-faint)]">
          ...
          <span>·</span>
          <span className="opacity-40">Spotify (soon)</span>
          <span>·</span>
          <span className="opacity-40">TikTok (soon)</span>
        </div>
